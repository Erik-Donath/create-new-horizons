...
- [Create: Deployer API](https://modrinth.com/mod/deployer)
...
- **Gamerules**
    - WaterSourceConversion is set to true
    - LavaSourceConversion is set to true
    - RandomTickSpeed is set to 12
